...
def main(cfg: DictConfig) -> None:
    ...
    lambda_ = cfg.setting.noise.lambda_
    supply_type_list = cfg.setting.noise.supply_type_list
    ...
    for supply_type in supply_type_list:
        ...
        plt.savefig(f"val_noise_{supply_type}.png")
        plt.close()
    ...
    for i, supply_type in enumerate(supply_type_list):
        ...
        ax.plot(noise_list, last_value, "-o", label=supply_type)
